...
pin_select            = digitalio.DigitalInOut(board.GPIO14)
...
pin_confirm           = digitalio.DigitalInOut(board.GPIO0)
...
tft_cs = board.GPIO06
tft_dc = board.GPIO07
display_bus = displayio.ParallelBus(data0 = board.GPIO39,
                                    command = board.GPIO07,
                                    chip_select = board.GPIO06,
                                    write = board.GPIO08,
                                    read  = board.GPIO09
)
